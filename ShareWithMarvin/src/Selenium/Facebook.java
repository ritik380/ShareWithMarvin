...
public class Facebook {
	public void fbpage(WebDriver driver, WebDriverWait wait) {
		...
		AddConnection.filldata(wait);
		
		WebElement selectFacebookPage = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='menu-channelType.id']//li[2]")));
		...
		/*WebElement dp = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("button[class='MuiButtonBase-root MuiFab-root MuiFab-circular MuiFab-sizeLarge MuiFab-default MuiFab-root MuiFab-circular MuiFab-sizeLarge MuiFab-default text-white bg-blue absolute bottom-20 right-[-8px] css-18uv35s']")));
		dp.click();
		
		WebElement browse = wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("text-3xl text-blue")));
		
		 String imagePath = "C:\\Users\\Ritik raj\\Downloads\\pexels-junior-teixeira-2047905.jpg"; 
		...
		WebElement selectProfile = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".MuiInputBase-root.MuiOutlinedInput-root.MuiInputBase-colorPrimary.MuiInputBase-fullWidth.MuiInputBase-formControl.MuiInputBase-adornedEnd.MuiAutocomplete-inputRoot.css-e3k1z2")));
